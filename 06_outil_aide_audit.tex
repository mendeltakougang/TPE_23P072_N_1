...
\begin{tikzpicture}[
  ...
  arrow/.style={-Stealth, thick, color=CouleurPrimaire},
  level/.style={sibling distance=8cm, level distance=1.1cm}
]
  \node[fill=CouleurPrimaire!20, text=CouleurPrimaire, font=\small\bfseries]
       {Niveau~1 \quad \textbf{Domaine}}
    child[arrow] { node[fill=CouleurSecondaire!10]
       {Niveau~2 \quad \textbf{Point de contrôle}}
      child[arrow] { node[fill=CouleurSecondaire!10]
         {Niveau~3 \quad \textbf{Objectif de contrôle}}
        child[arrow] { node[fill=CouleurBordLizbiz!10]
           {Niveau~4 \quad \textbf{Critère}}
          child[arrow] { node[fill=CouleurBordLizbiz!10]
             {Niveau~5 \quad \textbf{Élément requis}}
            child[arrow] { node[fill=CouleurPrimaire!10]
               {Niveau~6 \quad \textbf{Question d'évaluation}}
              child[arrow] { node[fill=CouleurBordAlerte!10]
                 {Niveau~7 \quad \textbf{Risque}}
                child[arrow] { node[fill=CouleurBordAlerte!20]
